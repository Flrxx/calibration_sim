...
if __name__ == "__main__":
    ...
    parser.add_argument("-i", "--input",  default="datasets/ARM95/wire/calibration/calibration_dataset.csv", help="Путь к входному CSV с данными")
    parser.add_argument("-o", "--output", default="results/ARM95/test.csv", help="Путь к выходному CSV с результатами")
