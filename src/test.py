...
if __name__ == "__main__":
    ...
    parser.add_argument("-i", "--input", default="results/ARM95/validation_results_calib.csv", help="Путь к исходному CSV датасету")

    parser.add_argument("-o", "--output", default="results/ARM95/test.csv", help="Путь для сохранения нового CSV")
